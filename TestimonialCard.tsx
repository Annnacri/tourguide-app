...
const TestimonialCard: React.FC<TestimonialInfo> = ({ avatarInitials, avatarBgClass, name, role, quote, rating }) => {
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300">
      <div className="flex items-center mb-4">
        <div className={`w-12 h-12 ${avatarBgClass} rounded-full flex items-center justify-center text-white font-bold text-lg`}>
          {avatarInitials}
        </div>
        <div className="ml-4">
